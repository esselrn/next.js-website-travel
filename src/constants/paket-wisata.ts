  ...
  featured: [
    {
      ...
      price: "Rp. 8.500.000",
      desc:
        "Eksplorasi surga bawah laut Raja Ampat dengan snorkeling, island hopping, dan panorama alam.",
    },
    {
      ...
      price: "Rp. 4.200.000",
      desc:
        "Nikmati keindahan Pantai Kuta Mandalika, Gili Trawangan, dan budaya Sasak.",
    },
  ],
  regular: [
    {
    ...
    },
    {
      ...
      price: "Rp. 3.900.000",
      desc:
        "Wisata budaya Batak dan panorama danau vulkanik terbesar di Asia Tenggara.",
    },
    {
      ...
      price: "Rp. 4.800.000",
      desc:
        "Wisata budaya unik dengan rumah adat Tongkonan dan pegunungan.",
    },
  ],
}